  ...
  function buildAdminPanel() {
    ...
    el.innerHTML = [
      '<div class="admin-sheet" style="max-height:88vh;overflow-y:auto;-webkit-overflow-scrolling:touch;">',
        '<div class="admin-top">',
          '<div class="admin-title">Управление</div>',
          '<button class="admin-close" onclick="closeAdminPanel()">&times;</button>',
        '</div>',

        // Табы — те же классы что в редакторе блюд
        '<div class="admin-tabs">',
          '<button class="admin-tab active" data-panel-tab="users" onclick="switchAdminPanelTab(\'users\')">Пользователи</button>',
          '<button class="admin-tab" data-panel-tab="permissions" onclick="switchAdminPanelTab(\'permissions\')">Доступ</button>',
        '</div>',
